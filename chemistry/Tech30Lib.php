...
function verifyGLogin() {
    if (getSession('userInfo') !== null) {
        ...
        setSession('cssURL', "http://www.pumatech.org/mrH/demo/GoogleSignin/Tech30.css");
        setSession('signinMsg', "Welcome to the KFC Kingdom!");
        setSession('signoutMsg', "You have left the realm of KFC...");
...
function MYSQLConnect () {
	...
	$link = @mysqli_connect($host, $un, $pw) or die (mysql_error());
